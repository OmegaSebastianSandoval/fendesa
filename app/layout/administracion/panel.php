...
<body>
    ...
    <footer class="panel-derechos col-md-12">&copy;<?php echo date('Y') ?> Todos los derechos reservados | Diseñado por <a href="https://omegasolucionesweb.com" target="_blank" style="text-decoration:none;color:white"> Omega Soluciones Web </a>
    </footer>
    <!-- Jquery -->
