<div id="carouselExampleIndicators" class="carousel slide">
	<div class="carousel-indicators">
		<?php foreach ($this->contenidoCarousel as $key => $value) { ?>
		...
		<?php foreach ($this->contenidoCarousel as $key => $value) { ?>
			<div class="carousel-item <?php echo   $key == 0 ? 'active' : '' ?>">
				<div class="row  justify-content-center">
					<div class="col-3">
						<img src="/images/<?php echo $value->contactenos_interna_img ?>" class="rounded-circle w-100" alt="">
					</div>
					<div class="col-6 d-flex flex-column justify-content-center">
						<h3 style="color:<?php echo $this->contactanos->contactenos_color_fondo_1; ?>;"><?php echo $value->contactenos_titulo_interno ?></h3>
						<p class="mb-0 cargo" style="color:<?php echo $this->contactanos->contactenos_color_fondo; ?>;"><?php echo $value->contactenos_cargo ?></p>
					</div>
					<div class="col-9">
						<div class="text mt-2" style="">
							<?php echo $value->contactenos_descripcion2 ?>
						</div>
					</div>
