<div class="container" style="margin-bottom: 245px;">
   ...
   ***************************************
    ...
    <div class="col-1 d-flex gap-3 justify-content-center flex-column align-items-center">
      <?php foreach ($this->botonesFlotantes as $boton) { ?>

        <a href="<?php echo $boton->publicidad_enlace; ?>" class="btn-flotante" <?php if ($boton->publicidad_tipo_enlace == 1) {
                                                                                  echo "target='_blank'";
                                                                                } ?> style="background: <?php echo $boton->publicidad_color_fondo ?>;">
          <img src="/images/<?php echo $boton->publicidad_imagen; ?>" class="img-fluid" alt="">
        </a>
      <?php } ?>
   ...
   ***************************************
     ...
     *************************************** -->
          <img class="icon2" src="/images/<?php echo $this->contactanos->contactenos_logo2; ?>" alt="" style="background: <?php echo $this->contactanos->contactenos_color_escribenos; ?>;">
          <!--***************************************
    FIN ICONO CIRCULAR
     *************************************** -->
     ...
     *************************************** -->
          <div class="text mt-5" style="line-height: 1;">
            <?php echo $this->contactanos->contactenos_descripcion; ?>
          </div>
    ...
    TITULO FORMULARIO
     *************************************** -->
          <h2 style="color: <?php echo $this->contactanos->contactenos_color_escribenos; ?>;"><?php echo $this->contactanos->contactenos_escribenos; ?></h2>

          <!--***************************************
     INICIO TEXTO DEL CORREO
     *************************************** -->
          <div class="text-correo d-flex align-items-center gap-2">
            <span><i class="fa-regular fa-envelope" style="color: <?php echo $this->contactanos->contactenos_color_escribenos; ?>; font-size:2rem !important"></i></span>


            <?php
            $cadena = $this->infopage->info_pagina_correos_contacto;
            $partes = explode('@', $cadena);

            if (count($partes) === 2) {
              $usuario = $partes[0]; // parte antes del @
              $dominio = $partes[1]; // parte después del @

            }
            ?>
            <span class="my-2" style="font-weight:400">
              <?php echo $usuario ?><span style="color: <?php echo $this->contactanos->contactenos_color_escribenos; ?>;">@<?php echo $dominio ?></span>
            </span>
          </div>
          <!--***************************************
     FIN TEXTO DEL CORREO
     *************************************** -->
          <!--***************************************
     INICIO FORMULARIO
     *************************************** -->
          <form action="/page/contacto/enviar" method="POST" class="mt-3">
            <div class="d-flex flex-column gap-4">
              ...
              <input class="input" type="hidden" name="lastname" placeholder="lastname" value="1" required>
              <input class="input" type="hidden" name="phone" placeholder="phone" value="1" required>
              <input class="input d-none" type="text" name="message" placeholder="message">

              <input class="input" type="text" name="asunto" placeholder="Asunto" required>
              <textarea class="input textarea" name="mensaje" placeholder="Mensaje" id="" required cols="30" rows="10"></textarea>
            </div>
            <div class="content-enviar d-flex justify-content-center mt-3 align-items-center">

              <!--
   ***************************************
   INICIO BOTON ENVIAR FORMULARIO
     ***************************************
    -->
              <div class="btn-conteiner">

                <button class="btn-content border-0" type="submit" style="background:<?php echo $this->contactanos->contactenos_btn1_color; ?>; color: <?php echo $this->contactanos->contactenos_color_txt; ?>;">



                  <span class="btn-title" style="background:<?php echo $this->contactanos->contactenos_btn6_color; ?>;">
                    <img src="/images/<?php echo $this->contactanos->contactenos_btn6_img; ?>" alt="" style="width: 40px;">
                    <?php echo $this->contactanos->contactenos_btn6_txt; ?>
                  </span>
...
<?php if ($this->status && $this->status == 'ok') { ?>
  <script>
    Swal.fire(
      '¡Genial!',
...
<?php if ($this->status && $this->status == 'error') { ?>
  <script>
    Swal.fire(
      'error',
      'El formulario no pudo ser enviado',
      'error'
    )
  </script>
<?php } ?>
...
<style>
  ...
  @keyframes color_anim2 {
    ...
    50% {
      fill:
        <?php echo $this->contactanos->contactenos_btn6_color; ?>;
    }
  ...
  @-webkit-keyframes btn-content2 {
    0% {
      outline: 0.2em solid <?php echo $this->contactanos->contactenos_btn6_color; ?>;
      outline-offset: 0;
    }
  }
