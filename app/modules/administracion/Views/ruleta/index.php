        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-6">
		            ...
		            <input type="text" class="form-control" name="ruleta_icono_principal" value="<?php echo $this->getObjectVariable($this->filters, 'ruleta_icono_principal') ?>"></input>
		            </label>
		        </div>
<!-- 				<div class="col-3">
		            <label>Imagen cabezote</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rosado " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="ruleta_img_cabezon" value="<?php echo $this->getObjectVariable($this->filters, 'ruleta_img_cabezon') ?>"></input>
		            </label>
		        </div> -->
                <div class="col-3">
                    <label>&nbsp;</label>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			<thead>
				<tr>
					...
					<td>Icono principal</td>
					<td>Imagen cabezote</td>
			...
			<tbody>
				...
				<?php $id =  $content->ruleta_id; ?>
					<tr>
						<td><?=$content->ruleta_fendyshop_txt;?></td>
						<td>
							<?php if($content->ruleta_icono_principal) { ?>
								<img src="/images/<?= $content->ruleta_icono_principal; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->ruleta_icono_principal; ?></div>
						</td>

						<td>
							<?php if($content->ruleta_img_cabezon) { ?>
								<img src="/images/<?= $content->ruleta_img_cabezon; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->ruleta_img_cabezon; ?></div>
						</td>
						<td>
