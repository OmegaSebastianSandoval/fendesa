...
<div class="container-fluid">
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>" data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<hr>
			<div class="row mt-5">
			<p class="fs-2 text-muted fw-bold">Ajustes del formulario</p>

				<div class="col-4 form-group">
					<label for="contactenos_logo2">Logo del formulario</label>
				...
				<div class="col-4 form-group">
					<label for="contactenos_color_bandera2" class="control-label">Color bandera del formulario</label>
					<label class="input-group">
				...
				<div class="col-4 form-group">
					<label for="contactenos_escribenos" class="control-label">Título del formulario</label>
					<label class="input-group">
				...
				<div class="col-4 form-group">
					<label for="contactenos_color_escribenos" class="control-label">Color del título del formulario</label>
					<label class="input-group">
			...
			<div class="row mt-5 d-none">
				...
				<div class="col-2 form-group">
					<label for="contactenos_btn1_img">Bot&oacute;n 1 icono</label>
					<input type="file" name="contactenos_btn1_img" id="contactenos_btn1_img" class="form-control  file-image" data-buttonName="btn-primary" accept="image/gif, image/jpg, image/jpeg, image/png">
					<div class="help-block with-errors"></div>
					<?php if ($this->content->contactenos_btn1_img) { ?>
						<div id="imagen_contactenos_btn1_img">
							<img src="/images/<?= $this->content->contactenos_btn1_img; ?>" class="img-thumbnail thumbnail-administrator" />
							<div><button class="btn btn-danger btn-sm" type="button" onclick="eliminarImagen('contactenos_btn1_img','<?php echo $this->route . "/deleteimage"; ?>')"><i class="glyphicon glyphicon-remove"></i> Eliminar Imagen</button></div>
						</div>
					<?php } ?>
				</div>
				...
				<div class="col-2 form-group">
					<label for="contactenos_btn2_link" class="control-label">Bot&oacute;n 2 link</label>
					<label class="input-group">

						<input type="text" value="<?= $this->content->contactenos_btn2_link; ?>" name="contactenos_btn2_link" id="contactenos_btn2_link" class="form-control">
					</label>
					<div class="help-block with-errors"></div>
				</div>
				...
				<div class="col-2 form-group">
					<label for="contactenos_btn3_link" class="control-label">Bot&oacute;n 3 link</label>
					<label class="input-group">

						<input type="text" value="<?= $this->content->contactenos_btn3_link; ?>" name="contactenos_btn3_link" id="contactenos_btn3_link" class="form-control">
					</label>
					<div class="help-block with-errors"></div>
				</div>
			</div>
			<div class="row">
			<p class="fs-2 text-muted fw-bold">Descripción de la parte izquierda del formulario</p>

				 <div class="col-12 form-group">
				<label for="contactenos_descripcion" class="form-label">Descripci&oacute;n</label>
...
<div class="botones-acciones">
	...
	<a href="/administracion/contactenos/manage?id=1" class="btn btn-cancelar">Cancelar</a>
</div>
</form>
</div>
