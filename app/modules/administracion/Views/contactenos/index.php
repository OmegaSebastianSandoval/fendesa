		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->contactenos_id; ?>
					<tr>
						<td><?=$content->contactenos_titulo;?></td>
						<td>
							<?php if($content->contactenos_cuadro_img_fondo) { ?>
								<img src="/images/<?= $content->contactenos_cuadro_img_fondo; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->contactenos_cuadro_img_fondo; ?></div>
						</td>
						<td class="text-right">
							<div>
