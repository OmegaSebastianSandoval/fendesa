	...
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>" data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="col-12 form-group d-grid">
					...
					<input type="checkbox" name="imagen_estado" value="1" class="form-control switch-form " <?php if ($this->getObjectVariable($this->content, 'imagen_estado') == 1) {
																												echo "checked";
																											} ?>></input>
				...
				<div class="col-4 form-group">
					...
					<input type="file" name="imagen_imagen" id="imagen_imagen" class="form-control  file-image" data-buttonName="btn-primary" accept="image/gif, image/jpg, image/jpeg, image/png" <?php if (!$this->content->imagen_id) {
																																																		echo 'required';
																																																	} ?>>
					<div class="help-block with-errors"></div>
				...
				<div class="col-4 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?php if ($this->content->imagen_fecha) {
														echo $this->content->imagen_fecha;
													} else {
														echo date('Y-m-d');
													} ?>" name="imagen_fecha" id="imagen_fecha" class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="es">
					</label>
					<div class="help-block with-errors"></div>
				</div>
				...
				<div class="col-12 form-group mt-2">
					...
					<textarea name="imagen_descripcion" id="imagen_descripcion" class="form-control tinyeditor mt-5" rows="10"><?= $this->content->imagen_descripcion; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>



				<input type="hidden" name="imagen_album" value="<?php if ($this->content->imagen_album) {
																	echo $this->content->imagen_album;
																} else {
																	echo $this->album;
																} ?>">
			</div>
		...
		<div class="botones-acciones">
			...
			<a href="<?php echo $this->route; ?>?album=<?php if ($this->content->imagen_album) {
															echo $this->content->imagen_album;
														} else {
															echo $this->album;
