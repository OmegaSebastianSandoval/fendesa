<div class="container-fluid">
	<form enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>" data-bs-toggle="validator">
		...
		<a id="avisolegal" name="avisolegal"></a>
		<div class="div-dashboard">
			<h2>
				<img src="/skins/administracion/images/seo.png"> Aviso legal
			</h2>
			<div class="pading-dashboard">
				<div class="row">
					<div class="col-12">
				...
				<div class="row">
					<div class="col-12">
						<div><label>Título</label>
							...
							<input type="text" name="info_pagina_titulo_politica" id="info_pagina_titulo_politica" class="form-control" value="<?= $this->content->info_pagina_titulo_politica; ?>">
						</div>
						<div style="margin-top:2%;">
							<label>Descripción</label>
							<textarea name="info_pagina_descripcion_politica" id="info_pagina_descripcion_politica" class="form-control tinyeditor" rows="10"><?= $this->content->info_pagina_descripcion_politica; ?></textarea>
