...
<div class="div-dashboard">
	<h2>
		<img src="/skins/administracion/images/seo.png"> Aviso legal  <a href="/administracion/informacion/#avisolegal"><i class="fas fa-marker"></i></a>
	</h2>
	<div class="pading-dashboard">
	...
	<div class="pading-dashboard">
		...
		<table class="table table-bordered">
			<tbody>
				...
				<tr>
					<td><?= $this->info->info_pagina_titulo_politica; ?></td>
				</tr>
				<tr>
					<th>Descripción</th>
				</tr>
				<tr>
					<td><?= $this->info->info_pagina_descripcion_politica; ?></td>
				</tr>
