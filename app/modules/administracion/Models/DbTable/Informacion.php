...
class Administracion_Model_DbTable_Informacion extends Db_Table
{
	...
	public function update($data,$id){
		...
		$info_pagina_descripcion_politica = $data['info_pagina_descripcion_politica'];
		 ...
		 info_pagina_titulo_politica='$info_pagina_titulo_politica',info_pagina_descripcion_politica='$info_pagina_descripcion_politica',info_pagina_favicon='$info_pagina_favicon' WHERE info_pagina_id = '".$id."'";
		 $res = $this->_conn->query($query);
	}
}