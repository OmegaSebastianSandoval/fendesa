...
class Administracion_informacionController extends Administracion_mainController
{
	...
	private function getData()
	{
		...
		$data['info_pagina_titulo_politica'] = $this->_getSanitizedParamHtml("info_pagina_titulo_politica");
		$data['info_pagina_descripcion_politica'] = $this->_getSanitizedParamHtml("info_pagina_descripcion_politica");
