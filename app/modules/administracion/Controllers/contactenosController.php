...
*/
class Administracion_contactenosController extends Administracion_mainController
{
	public $botonpanel = 7;
	/**
	...
	public function init()
	{
		...
		$this->route = "/administracion/contactenos";
	...
	public function insertAction(){
		...
		if (Session::getInstance()->get('csrf')[$this->_getSanitizedParam("csrf_section")] == $csrf ) {	
			...
			if($_FILES['contactenos_btn1_img']['name'] != ''){
				$data['contactenos_btn1_img'] = $uploadImage->upload("contactenos_btn1_img");
			}
	...
	public function updateAction(){
		...
		if (Session::getInstance()->get('csrf')[$this->_getSanitizedParam("csrf_section")] == $csrf ) {
			...
			if ($content->contactenos_id) {
				...
				if($_FILES['contactenos_btn1_img']['name'] != ''){
					if($content->contactenos_btn1_img){
						$uploadImage->delete($content->contactenos_btn1_img);
					}
					$data['contactenos_btn1_img'] = $uploadImage->upload("contactenos_btn1_img");
				} else {
					$data['contactenos_btn1_img'] = $content->contactenos_btn1_img;
				}
		...
		if (Session::getInstance()->get('csrf')[$this->_csrf_section] == $csrf ) {
			...
			if (isset($id) && $id > 0) {
				...
				if (isset($content)) {
					...
					if (isset($content->contactenos_btn1_img) && $content->contactenos_btn1_img != '') {
						$uploadImage->delete($content->contactenos_btn1_img);
					}
	...
	private function getData()
	{
		...
		$data['contactenos_btn2_link'] = $this->_getSanitizedParam("contactenos_btn2_link");
		$data['contactenos_btn3_color'] = $this->_getSanitizedParam("contactenos_btn3_color");
		$data['contactenos_btn3_img'] = "";
		$data['contactenos_btn3_link'] = $this->_getSanitizedParam("contactenos_btn3_link");
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['contactenos_cuadro_img_fondo'] =  $this->_getSanitizedParam("contactenos_cuadro_img_fondo");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
